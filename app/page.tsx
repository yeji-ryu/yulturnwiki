...
const HARD_CODED_USERS: UserAccount[] = [
  ...
  { id: '하지영', password: '8754', name: '하지영', role: '인턴', isAdmin: false },
  { id: '이하늘', password: '8609', name: '이하늘', role: '인턴', isAdmin: false },
  { id: '변가연', password: '2286', name: '변가연', role: '인턴', isAdmin: false },
  { id: '김민서', password: '7657', name: '김민서', role: '인턴', isAdmin: false },
  { id: '주황용', password: '2128', name: '주황용', role: '인턴', isAdmin: false },
  { id: '김윤하', password: '3740', name: '김윤하', role: '인턴', isAdmin: false },
  { id: '이수현', password: '1157', name: '이수현', role: '인턴', isAdmin: false },
  { id: '이주원', password: '5383', name: '이주원', role: '인턴', isAdmin: false },
  { id: '박재선', password: '2004', name: '박재선', role: '인턴', isAdmin: false },
  { id: '김가영', password: '3803', name: '김가영', role: '인턴', isAdmin: false },
  { id: '가혜원', password: '2482', name: '가혜원', role: '인턴', isAdmin: false },
  { id: '문승희', password: '9496', name: '문승희', role: '인턴', isAdmin: false },
  { id: '김현서', password: '8827', name: '김현서', role: '인턴', isAdmin: false },
  { id: '이래은', password: '2659', name: '이래은', role: '인턴', isAdmin: false },
  { id: '조수경', password: '3755', name: '조수경', role: '인턴', isAdmin: false },
  { id: '표은우', password: '0355', name: '표은우', role: '인턴', isAdmin: false },
  { id: '배성희', password: '5940', name: '배성희', role: '인턴', isAdmin: false },
  { id: '권윤수', password: '2198', name: '권윤수', role: '인턴', isAdmin: false },
  { id: '유호용', password: '8020', name: '유호용', role: '인턴', isAdmin: false },
  { id: '김자예', password: '0950', name: '김자예', role: '인턴', isAdmin: false },
